...
@XmlRootElement(name = "ItemServiceFindKeysResponse", namespace = "http://schemas.microsoft.com/dynamics/2008/01/services")
public class ItemServiceFindKeysResponse {
